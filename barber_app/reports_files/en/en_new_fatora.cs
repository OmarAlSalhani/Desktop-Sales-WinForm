...
{
    public partial class en_new_fatora : DevExpress.XtraReports.UI.XtraReport
    {
        public en_new_fatora()
        {
            InitializeComponent();
        ...
        public static void to_pdf(System.Data.DataTable products_datasource)
        {
            ...
            en_new_fatora report = new en_new_fatora();
        ...
        void set_report_detailes()
        {
            ...
            customer_tax_number_tb.Text = fatora_forms.ar_pos_uc.customer_tax_number.Length != 0 ? "VAT : " + fatora_forms.ar_pos_uc.customer_tax_number : "";
            customer_address_tb.Text = fatora_forms.ar_pos_uc.customer_address.Length >2 ? "ADDRESS : " +fatora_forms.ar_pos_uc.customer_address+" - "+fatora_forms.ar_pos_uc.customer_street+" - "+fatora_forms.ar_pos_uc.customer_building : "";
            customer_sgl_tb.Text = fatora_forms.ar_pos_uc.customer_sgl.Length != 0 ? "C.R : " + fatora_forms.ar_pos_uc.customer_sgl : "";
            customer_second_mobile_tb.Text = fatora_forms.ar_pos_uc.customer_second_number.Length != 0 ? "CONTACT : " + fatora_forms.ar_pos_uc.customer_second_number : "";
